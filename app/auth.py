...
def is_inventory_manager(user: User) -> bool:
    """Admin, SubAdmin, or IM — full warehouse visibility and issue/return management."""
    return check_any_role(user, ["Admin", "SubAdmin", "IM"])
...
DEFAULT_PERMISSIONS = [
    ...
    # ==================== HIERARCHY / INVENTORY WORKFLOW (Spec 00 stubs) ====================
    # Exact dotted keys match docs/workflow-specs/00-roles-status-foundations.md.
    # Enforced in Spec 01+; seeded now so JWT / frontend gates can reference them.
    {"name": "hierarchy_config.manage", "description": "Manage hierarchy configurations (Spec 01)"},
    {"name": "project.assign_hm", "description": "Assign Hierarchy Manager to a project (PD)"},
    {"name": "project.create_draft", "description": "Create project draft (HM)"},
    {"name": "project.approve", "description": "Approve project draft (Admin)"},
    {"name": "hierarchy.generate", "description": "Generate hierarchy from configuration (HM)"},
    {"name": "inventory.reserve", "description": "Reserve inventory for hierarchy nodes (HM)"},
    {"name": "inventory.release", "description": "Release reserved inventory (HM / System)"},
    {"name": "inventory.receive", "description": "Receive stock / shortage fulfillment (IM)"},
    {"name": "inventory.issue", "description": "Issue inventory to developer (IM)"},
    {"name": "hierarchy.assign_developer", "description": "Assign developer to hierarchy work (HM)"},
    {"name": "item.request", "description": "Request issued item (Developer)"},
    {"name": "item.install_test", "description": "Install and test item (Developer)"},
    {"name": "item.verify", "description": "Verify installed item (HM)"},
    {"name": "item.inspect", "description": "Inspect returned item (IM)"},
    {"name": "project.cancel", "description": "Cancel project / trigger recall (PD / HM)"},
    {"name": "config_change.request", "description": "Request configuration change (HM)"},
    {"name": "config_change.approve", "description": "Approve configuration change (Admin)"},
    {"name": "audit.read", "description": "Read workflow audit trail (Admin + limited)"},
]
...
DEFAULT_ROLES = [
    ...
    # ----- Spec 00 workflow roles (codes as Role.name except Admin above) -----
    {
        "name": "PD",
        "description": "Project Director — assign HM; cancel / recall",
        "permissions": [
            "view_users",
            "view_projects",
            "view_systems",
    ...
    {
        "name": "HM",
        "description": "Hierarchy Manager — draft, hierarchy, reserve, assign, verify",
        "permissions": [
            "view_users",
            "view_projects",
            "create_projects",
    ...
    {
        "name": "IM",
        "description": "Inventory Manager — stock, issue, inspect, shortage receipt",
        "permissions": [
            "view_users",
            "view_projects",
            "view_systems",
    ...
    {
        "name": "DEV",
        "description": "Developer — request, install, test, report",
        "permissions": [
            "view_projects",
            "view_systems",
            "view_subsystems",
